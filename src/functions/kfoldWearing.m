...
states = trainingClassifierData.wearing;
...
yvec_nums = cell2vec(cellstr(trainingClassifierData.wearing)');
c = 10;
gamma = .1;
...
[svmPredictedStates classifierFit P acc preStateTest] = classify('svm',trainingClassifierData.features,...
    cellstr(trainingClassifierData.wearing)',testVector,c,gamma);
